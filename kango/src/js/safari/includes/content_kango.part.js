...
listeners.push(listener);}};(new KangoInvokeAsyncModule()).init(kango);(new KangoMessageTargetModule()).init(kango);};window.addEventListener('DOMContentLoaded',function(){kango._init('document-end');},false);kango._init('document-start');