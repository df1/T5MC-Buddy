...
*/
kango.Storage=function(){};kango.Storage.prototype=kango.oop.extend(kango.IStorage,{getItem:function(name){var value=localStorage.getItem(name);if(typeof value!='undefined'){return JSON.parse(value);}
...
return keys;}});kango.storage=new kango.Storage();